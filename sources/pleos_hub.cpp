...
namespace pleos {
    ...
    std::shared_ptr<scls::GUI_Object> Hub_Page::__create_loaded_object_from_type(std::string object_name, std::string object_type, scls::GUI_Object* parent) {
        ...
        GUI_OBJECT_CREATION(scls::GUI_Text, a_navigation_notes_button, "hub_navigation_notes_button")
    ...
    void Hub_Page::check_navigation() {
        ...
        if(a_navigation_notes_button.get()->is_clicked_during_this_frame(GLFW_MOUSE_BUTTON_LEFT)) {window_struct()->hide_all_pages_2d();window_struct()->display_page_2d("notes");}
